...
<script type="text/javascript">
    ...
    $(function () {
        $("#maingrid4").ligerGrid({
            checkbox: false,
            columns: [
                { display: '消息标题', name: 'title', minWidth: 150 },
                { display: '消息类型', name: 'types', minWidth: 110 },
                { display: '消息内容', name: 'content', minWidth: 300 },
                { display: '消息状态', name: 'statuss', minWidth: 100 },
                { display: '接收时间', name: 'sendTime', minWidth: 182,render: function (rowdata, rowindex, value)
                {
                    var d;
                    if(value > 0 ){
