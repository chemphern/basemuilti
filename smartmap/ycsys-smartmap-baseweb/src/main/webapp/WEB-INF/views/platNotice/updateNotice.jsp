...
<body>
<form action="${ctx}/platNotice/updateNotice" method="post" id="form_id">
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="date_add_table">
        <tr>
            <td class="t_r">消息标题：</td>
            <td>
                <input name="id" value="${notice.id}" style="display:none">
                <input type="text" name="title" value="${notice.title}" validate="{required:true,messages:{required:'必填'}}">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <textarea id="content" name="content" style="width:580px;height:200px;visibility:hidden;">${notice.content}</textarea>
            </td>
        </tr>
...
<script>
    ...
    $(function(){
        ...
        var p = window.parent;
        var dialog = p.art.dialog.list["updateNotice"];
        var $fm = $("#form_id");
