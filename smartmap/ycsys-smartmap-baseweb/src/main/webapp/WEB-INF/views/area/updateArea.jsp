    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="date_add_table">
        <tr>
            ...
            <td>
                ...
                <input type="text" name="name" id="name" validate="{required:true,messages:{required:'必填'}}" value="${area.name}"/></td>
        </tr>
        <tr>
            <td class="t_r">区域编码：</td>
            <td><input type="text" name="code" id="code" validate="{required:true,messages:{required:'必填'}}" value="${area.code}"/></td>
        </tr>
        <tr>
