...
<head>
    ...
    <title>羽辰智慧林业平台运维管理系统-服务器监控列表</title>
...
<script type="text/javascript">
        ...
        $(function () {
            $("#maingrid4").ligerGrid({
                ...
                columns: [
                    ...
                    { display: '服务器ip', name: 'url', minWidth: 60 },
                    { display: 'SNMP端口', name: 'snmpPort', minWidth: 60 },
        ...
        var dialog = $.Layer.iframe(
            {
                id:"addServerDialog",
                title: '新增服务器监控',
                url:'${ctx}/platMonitorConfig/addConfigv?type=1',
                width: 400,
                height: 350
            });
    };
    ...
    function yc_update(id){
        var dialog = $.Layer.iframe(
            {
                id:"updateServerDialog",
                title: '修改监控配置',
                url:'${ctx}/platMonitorConfig/updateConfigv?id=' + id + '&type=1',
                width: 400,
                height: 400
            });
    };
