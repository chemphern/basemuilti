...
<head>
    ...
    <title>羽辰智慧林业平台运维管理系统-平台监控配置Tomcat</title>
...
<form action="${ctx}/platMonitorConfig/saveOrUpdate" method="post" id="form_id">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="date_add_table">
        <tr>
            ...
            <td>
                <input type="text" name="monitorType" value="2" style="display:none"/>
        ...
        <tr>
            ...
            <td><input type="text" name="userName" id="userName" validate="{required:true,messages:{required:'必填'}}"/></td>
        </tr>
        <tr>
            <td class="t_r">Tomcat密码：</td>
            <td><input type="text" name="userPassword" id="userPassword" validate="{required:true,messages:{required:'必填'}}"/></td>
        </tr>
        <tr>
...
<script type="text/javascript">
    ...
    ;(function($){
        ...
        var dialog = p.art.dialog.list["addTomcatDialog"];
        var $fm = $("#form_id");
