...
<title>羽辰智慧林业平台运维管理系统-资源选择</title>
...
var tempResourceTypeId = null;
    ;(function($){  //避免全局依赖,避免第三方破坏
    	...
    	$(document).ready(function(){
			...
			var dialog = parentWin.art.dialog.list["selectResourceFileDialog"];
			...
			dialog_div.on("ok",function(){
				...
				if(selectedRows.length != 1) {
					...
					parentWin.document.getElementById("resourceFileId").value = selectedRows[0].id;
					parentWin.document.getElementById("resourceFileName").value = selectedRows[0].fullName;
					dialog.close();
				}
			});
    	});
